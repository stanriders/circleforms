...
export class PostsApi extends runtime.BaseAPI {
  ...
  async postsIdGetRaw(
    ...
    initOverrides?: RequestInit
  ): Promise<runtime.ApiResponse<PostWithQuestionsContract>> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        "id",
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      PostWithQuestionsContractFromJSON(jsonValue)
    );
  }
  ...
  async postsIdGet(
    requestParameters: PostsIdGetRequest,
    initOverrides?: RequestInit
  ): Promise<PostWithQuestionsContract> {
   ...
   * Update post. (Auth)
   */
  async postsIdPatchRaw(
    requestParameters: PostsIdPatchRequest,
    initOverrides?: RequestInit
  ): Promise<runtime.ApiResponse<FullPostContract>> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        "id",
        "Required parameter requestParameters.id was null or undefined when calling postsIdPatch."
      );
    }
