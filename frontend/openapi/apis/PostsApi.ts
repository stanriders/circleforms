...
export class PostsApi extends runtime.BaseAPI {
   ...
   */
  async postsAllCountGetRaw(initOverrides?: RequestInit): Promise<runtime.ApiResponse<number>> {
   ...
   * Get amount of cached posts
   */
  async postsAllCountGet(initOverrides?: RequestInit): Promise<number> {
    const response = await this.postsAllCountGetRaw(initOverrides);
  ...
  /**
   * Delete post if not published. (Auth)
   */
