...
export class UsersApi extends runtime.BaseAPI {
     ...
     */
    async meAnswersGetRaw(initOverrides?: RequestInit): Promise<runtime.ApiResponse<Array<AnswerPostContract>>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(AnswerPostContractFromJSON));
    }
