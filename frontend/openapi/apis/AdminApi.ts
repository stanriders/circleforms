...
export class AdminApi extends runtime.BaseAPI {
   ...
   */
  async adminPostsCachedGetRaw(
    initOverrides?: RequestInit
  ): Promise<runtime.ApiResponse<Array<MinimalPostContract>>> {
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(MinimalPostContractFromJSON)
    );
  }
   ...
   */
  async adminPostsCachedIdGetRaw(
    requestParameters: AdminPostsCachedIdGetRequest,
    initOverrides?: RequestInit
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        "id",
        "Required parameter requestParameters.id was null or undefined when calling adminPostsCachedIdGet."
      );
    }
    ...
    const response = await this.request(
      {
        path: `/admin/posts/cached/{id}`.replace(
          `{${"id"}}`,
   ...
   */
  async adminPostsMongoGetRaw(
    initOverrides?: RequestInit
  ): Promise<runtime.ApiResponse<Array<FullPostContract>>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(FullPostContractFromJSON)
    );
  }
   ...
   */
  async adminPostsMongoIdGetRaw(
    requestParameters: AdminPostsMongoIdGetRequest,
    initOverrides?: RequestInit
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters.id === null || requestParameters.id === undefined) {
      throw new runtime.RequiredError(
        "id",
        "Required parameter requestParameters.id was null or undefined when calling adminPostsMongoIdGet."
      );
    }
    ...
    const response = await this.request(
      {
        path: `/admin/posts/mongo/{id}`.replace(
          `{${"id"}}`,
          encodeURIComponent(String(requestParameters.id))
        ),
        method: "GET",
  ...
  async adminUsersGetRaw(
    initOverrides?: RequestInit
  ): Promise<runtime.ApiResponse<Array<UserContract>>> {
    const queryParameters: any = {};
    ...
    return new runtime.JSONApiResponse(response, (jsonValue) =>
      jsonValue.map(UserContractFromJSON)
    );
  }
   ...
   */
  async adminUsersPatchRaw(
    requestParameters: AdminUsersPatchRequest,
    initOverrides?: RequestInit
  ): Promise<runtime.ApiResponse<UserContract>> {
    const queryParameters: any = {};
