  ...
  return (
    <DefaultLayout>
      ...
      <div className="grid grid-cols-1 mt-4 gap-y-4 mx-4 mb-4 lg:grid-cols-4 lg:gap-0 lg:m-0">
          ...
          const MemberImage = () => (
            <a
              ...
              <img
                ...
                <div className={classNames("bg-black-lightest lg:hidden absolute bottom-0 left-0 right-0 p-4 rounded-t-14",
                member.name === 'StanR'
        ...
        <a href="https://discord.gg/rx9RKQsy9H" className="flex justify-center items-center bg-blue-discord col-span-2 text-white focus:brightness-90 hover:brightness-75 transition py-16 rounded-20 lg:py-0 lg:rounded-none">
