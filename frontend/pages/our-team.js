  ...
  return (
    <DefaultLayout>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 mt-4">
        {constants.team.map((member, index) => {
          const MemberImage = () => (
            <a
              ...
              className="col-span-2 relative h-64 lg:h-[211px] transition hover:brightness-75 lg:col-span-1">
              <img
              ...
              <img
                ...
                <div className="bg-black-lightest lg:hidden absolute bottom-0 left-0 right-0 p-4 rounded-t-14">
        ...
        <a href="https://discord.gg/rx9RKQsy9H" className="flex justify-center items-center bg-blue-discord col-span-2 text-white focus:brightness-90 hover:brightness-75 transition py-8 lg:py-0">
